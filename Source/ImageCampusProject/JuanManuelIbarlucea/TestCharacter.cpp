...
#include "ImageCampusProject/JuanManuelIbarlucea/HealthComponent_JM.h"
...
ATestCharacter::ATestCharacter()
{
	...
	HealthComponent = CreateDefaultSubobject<UHealthComponent_JM>(TEXT("HealthComponent"));
...
void ATestCharacter::Fire()
{
	...
	auto* Projectile = GetWorld()->SpawnActor<AProjectile_JM>(ProjectileClass, Transform);
}
